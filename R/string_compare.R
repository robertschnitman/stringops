...
#' 
#' @details The function \code{string_isblank} tests whether a vector consists of only blank characters. The \code{%like%} operator tests whether a pattern match is found in a string. The functions \code{string_isupper()} and \code{string_islower()} test whether each element in a string vector is all uppercase or lowercase, respectively. .
#' 
#' @examples
#' string_isblank("         ")
